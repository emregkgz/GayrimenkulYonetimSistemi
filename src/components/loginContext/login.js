...
function Login() {
  ...
  const [txtPasswordYazilanMetin, setTxtLoginPassword] = useState();
  ...
  const EnterLogin = async () => {
    let requestBody = {
      ...
      service_val_password: txtPasswordYazilanMetin,
    };
  ...
  return (
    <div>
      ...
      <div className="content">
        ...
        <form className="login-form">
          ...
          <div className="form-group">
            ...
            <input
              ...
              name="password"
              onChange={(e) => setTxtLoginPassword(e.target.value)}
            />
          </div>
        ...
        <form className="forget-form" action="/FormProjeApp" method="post">
