...
import SehirPopup from "./PopupSehir";
import Connection from "../../../Connection/Connection.js";

function ListeSehir(props) {
  ...
  const Delete = async (item) => {
    ...
    const response = await axios.delete(
      "http://localhost:8097/deleteCity",
      requestBody
    );
    console.log(response);
    if (response.data.result === "Success") {
      if (window.confirm("Silmek istediğinize emin misiniz?")) {
        window.alert("Sehir Bilgileri Silinmiştir!");
                            ...
                            <tr key={item.CityID}>
                              ...
                              <td>
                                ...
                                <Link
                                  ...
                                  onClick={() => Delete(item)}
                                >
                                  <i className="fa fa-trash-o"></i> SİL{" "}
                                </Link>
                              </td>
                            </tr>
                          ))}
