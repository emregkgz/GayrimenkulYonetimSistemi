...
import ProjeDurumuPopup from "./PopupProjeDurumu";
import Connection from "../../../Connection/Connection";

function ListeProjeDurumu(props) {
  const { getProjectStatusList } = props;
  const [openUpdate, setOpenUpdate] = useState(false);
  const [current, setCurrent] = useState("");
  const [openSubmit, openPopupSubmit] = useState(false);

  const handleClicktoOpenUpdate = (item) => {
    setOpenUpdate(true);
    setCurrent({
  ...
  const Delete = async (item) => {
    ...
    const response = await axios.delete(
      Connection.Port + "deleteProjectStatu",
      requestBody
    );

    if (response.data.result === "Success") {
      if (window.confirm("Silmek istediğinize emin misiniz?")) {
        window.alert("Proje Durum Bilgileri Silinmiştir!");
        ...
        <div className="page-content">
          <div className="container">
            ...
            <ul className="page-breadcrumb breadcrumb">
              ...
              <li>
                <a href="/listeleprojedurumu">Proje Durumu</a>
                <i className="fa fa-circle" />
              </li>
                          ...
                          {getProjectStatusList.map((item) => (
                            <tr key={item.ProjectStatusID}>
                              ...
                              >
                                ...
                                <Link to={""} value={item.ProjectStatusName}>
                              ...
                              <td>
                                <Link
                                  ...
                                  onClick={() => handleClicktoOpenUpdate(item)}
                                >
