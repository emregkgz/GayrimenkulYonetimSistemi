...
import GelirTipiPopup from "./PopupGelirTipi ";

function ListeGelirTipi(props) {
  ...
  const Delete = async (item) => {
    ...
    const response = await axios.delete(
      "http://localhost:8097/deleteIncomeType",
      requestBody
    );
        ...
        <div className="page-content">
          <div className="container">
            ...
            <ul className="page-breadcrumb breadcrumb">
              ...
              <li>
                <a href="/listelegelirtipi">Gelir Tipi</a>
                <i className="fa fa-circle" />
              </li>
                  ...
                  <div className="portlet-body">
                    <div className="table-scrollable">
                      <table className="table table-striped table-bordered table-advance table-hover">
                        <tbody>
                          {getIncomeTypeList.map((item) => (
                            <tr key={item.IncomeTypeID}>
                              <td className="highlight">
                                <div className="success"></div>
                                <a href="#" value={item.IncomeTypeName}>
                                  {item.IncomeTypeName}{" "}
                                </a>
                              </td>
                              <td>
