...
import GenderPopup from "./PopupGender";
import Connection from "../../../Connection/Connection.js";

function ListeCinsiyet(props) {
  const [openedit, setOpenedit] = useState(false);
  const [openpost, setOpenpost] = useState(false);
  const [seciliGender, setseciliGender] = useState("");
        ...
        <div className="page-content">
          <div className="container">
            ...
            <ul className="page-breadcrumb breadcrumb">
              ...
              <li>
                <a href="/listelecinsiyet">Cinsiyet</a>
                <i className="fa fa-circle" />
              </li>
                  ...
                  <div className="portlet-body">
                    <div className="table-scrollable">
                      <table className="table table-striped table-bordered table-advance table-hover">
                        {/* TBODY GELECEK */}
                        <tbody>
                          {props.getGenderList.map((item) => (
                            <tr key={item.GenderID}>
                              <td className="highlight">
                                <div className="success"></div>
                                <a href="#" value={item.GenderName}>
                                  {item.GenderName}{" "}
                                </a>
                              </td>
                              <td>
