...
import FormCalisanEdit from "./form_CalisanEdit";

function ListeCalisan(props) {
  ...
  const editRow = (item) => {
    ...
    setCurrentUser({
      ...
      txtName: item.EmployeeName,
      txtSurname: item.EmployeeSurname,
          ...
          <div className="page-content">
            <div className="container">
              ...
              <ul className="page-breadcrumb breadcrumb">
                ...
                <li>
                  <a href="/listelecalisan">Çalışan</a>
                  <i className="fa fa-circle" />
                </li>
                    ...
                    <div className="portlet-body">
                      <div className="table-scrollable">
                        <table className="table table-striped table-bordered table-hover">
                          ...
                          <tbody>
                            {/*  to={
                                    "listelecalisanedit?id=" + item.EmployeeID
                                  } */}
