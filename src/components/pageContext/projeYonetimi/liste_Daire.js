                        ...
                        <tbody>
                          {getFlatList.map((item) => (
                            <tr key={item.FlatID}>
                              ...
                              <td>
                                <Link
                                  to={"/listeledaireEdit?id=" + item.FlatID}
                                >
                                  {getProjectList
                                    .filter(
                                      (data) =>
                              ...
                              <td>
                                {getFlatType
                                  .filter(
                                    (data) =>
                                      data.FlatTypeID === item.FlatTypeID
                                  )
                                  .map((name) => name.FlatTypeName)}
                              </td>
                              <td>
                                {getFlatStatus
                                  .filter(
                                    (data) =>
                                      data.FlatStatusID === item.FlatStatusID
                                  )
                                  .map((name) => name.FlatStatusName)}
                              </td>
                              <td>{item.Price}</td>
                              <td>{item.tarih}</td>
                            </tr>
